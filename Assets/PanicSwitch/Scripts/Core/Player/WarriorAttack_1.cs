...
public class WarriorAttack_1 : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (YandexGame.HasObject("warriorLevel" + id))
            warriorLevel = YandexGame.GetInt("warriorLevel" + id);

        if (YandexGame.HasObject("warriorEnable" + id))
            warriorEnable = YandexGame.GetInt("warriorEnable" + id);
    ...
    public void UpgradeWarriors()
    {
        ...
        CheckWarriorAmmunition();
        YandexGame.SetInt("warriorLevel" + id, warriorLevel);
        _particleUpgrade.Play();
    }
    ...
    public void AddUnit()
    {
        CheckWarriorAmmunition();
        warriorEnable = 1;
        YandexGame.SetInt("warriorEnable" + id, 1);
        _particleUpgrade.Play();
    }
