...
public class UpgradeCatapults : MonoBehaviour
{
   ...
   // [SerializeField] private Image _progress;
    ...
    void Start()
    {
        ...
        if (YandexGame.HasObject("catapultCycle"))
        {
            _cycle = YandexGame.GetInt("catapultCycle");
        }
        ...
        _currentLevel = YandexGame.GetInt("_currentLevelCatapult");
    ...
    public void Upgrade()
    {
        ...
        if (_currentLevel > 5)
        {
            ...
            _currentLevel = 0;
            YandexGame.SetInt("catapultCycle", _cycle);
        }

        YandexGame.SetInt("_currentLevelCatapult", _currentLevel);
       // UpdateCatapults();
        UpdateText();
    }
