...
public class QuestManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            _waveLevel = YandexGame.GetInt("_waveLevelContinue");
            _menuUI.StartGame();
            YandexGame.DeleteObject("_waveLevelContinue");
        }
        else
        {
            CheckWaveLevel();
    ...
    {
        YandexGame.SetInt("_waveLevelContinue", _waveLevel);
        YandexGame.SetInt("tempLevel", _playerData.GetLevel());
        ContinueCounter++;
