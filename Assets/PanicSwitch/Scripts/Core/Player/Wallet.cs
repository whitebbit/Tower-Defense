...
public class Wallet : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _money = YandexGame.GetFloat("_money");
        _gems = YandexGame.GetInt("_gems");
    ...
    private void Start()
    {
        if (!YandexGame.HasObject("firstStart"))
        {
            SetMoney(1500);
            SetGems(10);
            YandexGame.SetInt("firstStart", 1);
        }
    ...
    public void SetMoney(float moneys)
    {
        ...
        YandexGame.SetFloat("_money", _money);
    }
}
