...
public class GameUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (!YandexGame.HasObject("tutorial"))
        {
            YandexGame.SetInt("tutorial", 1);
        }

        if (YandexGame.HasObject("gameCouner"))
            gameCouner = YandexGame.GetInt("gameCouner");
        else
            gameCouner = 1;
    ...
    {
        gameCouner +=value;
        YandexGame.SetInt("gameCouner", gameCouner);
    }
